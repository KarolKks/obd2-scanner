...
TIM_Status_t TIM3_Encoder_Init(void)
{
    ...
    // Configure PB4 (TIM3_CH1) and PB5 (TIM3_CH2) for Alternate Function AF2
    ...
    // Configure TIM3 in Quadrature Encoder Interface Mode (X2 TI1 mode)
    LL_TIM_SetEncoderMode(TIM3, LL_TIM_ENCODERMODE_X2_TI1);

    // Set input capture polarity and 8-clock digital input filter to eliminate mechanical chatter
    ...
    // Set 16-bit auto-reload value and reset counter to zero
